...
I never used Twitter “normally” — I always used third party clients. I never tolerated the algorithmic timeline. I was a completionist — I wanted to pick up where I left off and tried to make sure I read *everything* in my timeline. I was extremely picky who I followed, but because of that I really enjoyed my timeline.

I followed a few core communities that didn’t exist anywhere else. Seeing the writing on the wall, I still wanted to see what they had to say, even as I moved elsewhere. I followed everyone I could in other networks they were in, but there are a handful that don’t seem to have any presence other than Twitter.

Twitter ending the API as it has existed for more than a decade signals the end whether I like it or not.  When they unceremoniously cut off Twitterrific, I pruned everything back and used Reeder to follow as if it was an RSS feed. Now that’s likely going to fall by the wayside.
